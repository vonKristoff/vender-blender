...
window.onload = function () {
    ...
    function preventOverlap() {
        if (isSpringing)
            return; // Allow overlap during spring
    ...
    function getRoughPaths() {
        ...
        var arrowSize = 14;
        if (dist > 0) {
            var line = generator.line(midX - (dx / dist) * lineOffset, midY - (dy / dist) * lineOffset, midX + (dx / dist) * lineOffset, midY + (dy / dist) * lineOffset, { stroke: "#333", strokeWidth: lineWidth });
