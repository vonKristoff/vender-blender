...
export function roughVennDiagram(titles: string[], intersections: Intersection[] = [], diagramId = 0, universalSet?: string): string {
  ...
  const circles: [number, number, number][] = numSets === 1
